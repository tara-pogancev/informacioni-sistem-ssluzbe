...
public class DodavanjeProfesora extends JDialog {
	...
	public DodavanjeProfesora() {
		...
		okBtn.addActionListener(e -> {
			...
			if (unosIme.getText().isEmpty() || unosPrz.getText().isEmpty() || unosDat.getText().isEmpty()
					|| unosAdr.getText().isEmpty() || unosTel.getText().isEmpty() || unosEmail.getText().isEmpty()
					|| unosAdrK.getText().isEmpty() || unosBlc.getText().isEmpty() || unosTit.getText().isEmpty()
					|| unosZvanje.getText().isEmpty()) {
